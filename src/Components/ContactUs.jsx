      ...
      <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="max-w-2xl mx-auto text-center">
          ...
          <p class="max-w-xl mx-auto mt-4 text-base leading-relaxed text-white">
            ...
            suggestions, or need assistance with the Blog Platform, please feel
            free to reach out to us. Our team is here to help and ensure you
            have a great experience, We aim to respond to all inquiries within
            24-48 hours. Thank you for choosing our platform!.
          </p>
        </div>
                    ...
                    <div class="mt-8 space-y-7">
                      <div class="flex items-start">
                        ...
                        <span class="block ml-3 text-base text-gray-900">
                          {" "}
                          123 Dabka Rd. Waaberi, Banadir 9098, Somalia{" "}
                        </span>
                      </div>
